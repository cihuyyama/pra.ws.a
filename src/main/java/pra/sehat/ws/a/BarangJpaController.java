...
import pra.sehat.ws.a.exceptions.NonexistentEntityException;
import pra.sehat.ws.a.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pra_sehat.ws.a_jar_0.0.1-SNAPSHOTPU");
